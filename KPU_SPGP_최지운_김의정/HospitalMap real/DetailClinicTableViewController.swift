//
//  DetailClinicTableViewController.swift
//  HospitalMap real2
//
...
class DetailClinicTableViewController: UITableViewController, XMLParserDelegate {
    ...
    let postsname : [String] = ["약국명","주소","전화번호","홈페이지","간이약도"]
