...
class ViewController: UIViewController ,UIPickerViewDelegate, UIPickerViewDataSource, UIScrollViewDelegate{
    ...
    @IBOutlet weak var graphView: GraphViewHospital!
    @IBOutlet weak var counterView: CounterViewH!
    ...
    var url : String = "http://apis.data.go.kr/B551182/hospInfoService/getHospBasisList?pageNo=1&numOfRows=999&serviceKey=sea100UMmw23Xycs33F1EQnumONR%2F9ElxBLzkilU9Yr1oT4TrCot8Y2p0jyuJP72x9rG9D8CN5yuEs6AS2sAiw%3D%3D&sidoCd=110000&sgguCd="
